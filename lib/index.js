...
module.exports = function (app) {
    app.on('pull_request.opened', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var pattern, _a, number, title, body, _b, name, login, remaining, isMatch, bodyOutput;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    pattern = /\b[a-zA-Z]{3}\-{1}\d{3}\b|\b\d{6}\b/g;
                    _a = context.payload.pull_request, number = _a.number, title = _a.title, body = _a.body, _b = _a.head.repo, name = _b.name, login = _b.owner.login, remaining = __rest(_a, ["number", "title", "body", "head"]);
