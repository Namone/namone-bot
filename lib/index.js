...
module.exports = function (app) {
    ...
    app.on('pull_request.closed', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var _a, number, merged, _b, label, login, remaining;
        var _this = this;
        return __generator(this, function (_c) {
            _a = context.payload, number = _a.number, merged = _a.merged, _b = _a.head, label = _b.label, login = _b.user.login, remaining = __rest(_a, ["number", "merged", "head"]);
            if (!merged) {
                return [2 /*return*/];
            }
