...
var appId = process.env.SLACK_APP_ID;
module.exports = function (app) {
    ...
    app.on('pull_request.closed', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var _a, number, title, merged, _b, label, login, remaining;
        var _this = this;
        return __generator(this, function (_c) {
            app.log(context.payload);
            _a = context.payload.pull_request, number = _a.number, title = _a.title, merged = _a.merged, _b = _a.head, label = _b.label, login = _b.user.login, remaining = __rest(_a, ["number", "title", "merged", "head"]);
    ...
    app.on('deployment_status', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var _a, ref, _b, state, login, trackedBranches;
        var _this = this;
        return __generator(this, function (_c) {
            _a = context.payload, ref = _a.deployment.ref, _b = _a.deployment_status, state = _b.state, login = _b.creator.login;
            trackedBranches = [
                'master',
            ];
