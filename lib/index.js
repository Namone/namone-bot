...
module.exports = function (app) {
    ...
    app.on('pull_request.closed', function (context) { return __awaiter(_this, void 0, void 0, function () {
        var _a, number, html_url, title, merged, body, _b, label, login, remaining, message;
        return __generator(this, function (_c) {
            _a = context.payload.pull_request, number = _a.number, html_url = _a.html_url, title = _a.title, merged = _a.merged, body = _a.body, _b = _a.head, label = _b.label, login = _b.user.login, remaining = __rest(_a, ["number", "html_url", "title", "merged", "body", "head"]);
            message = {};
            if (!merged) {
                message = {
                    "attachments": [
